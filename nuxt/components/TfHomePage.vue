...
<template>
    <div class="h-screen w-screen d-flex flex-column align-center pt-5 pb-12 bg-whiteSub overflow-auto">
        ...
        <TfTextInput label="Where do you want to go?" placeholder-text="Location" classes="mt-8"
        ...
        <TfIntegerInput label="How many people are going?" placeholder-text="Number" classes="mt-6" :number-value="people"
